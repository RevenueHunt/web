...
const BESPOKE: OgPage[] = [
  ...
  { slug: "solutions-supplements", title: "Supplement quiz", subtitle: "Turn health goals into a recommended stack from your catalog." },
  { slug: "solutions-fashion", title: "Fashion style quiz", subtitle: "Find the right fit, cut, and color, and cut returns." },
  { slug: "solutions-coffee", title: "Coffee quiz", subtitle: "Match roast and brew preferences, and onboard subscribers." },
  { slug: "solutions-fitness", title: "Fitness quiz", subtitle: "Goal-based gear, apparel, and programs from your catalog." },
  { slug: "solutions-pet-products", title: "Pet product quiz", subtitle: "Match food and gear by species, breed, age, and allergies." },
  { slug: "solutions-cbd", title: "CBD product finder", subtitle: "Guide shoppers to the right format and strength by goal." },
  { slug: "solutions-jewelry", title: "Jewelry quiz", subtitle: "Match style, metal, and occasion to the right piece." },
  { slug: "solutions-home-goods", title: "Home & decor quiz", subtitle: "Match furniture and decor to a shopper's space and style." },
  { slug: "solutions-gift-finder", title: "Gift finder quiz", subtitle: "Ask about the recipient, return a curated gift they'll love." },
  { slug: "solutions-size-finder", title: "Size & fit finder", subtitle: "Recommend the right size or compatible product, and cut returns." },
