...
On Built for Shopify, the subscription option lives directly on the **Results Page** as part of the Product Block layout. ReCharge (Pro plan) is supported and Shopify Subscriptions is rolling out.
...
The quiz design is what determines whether subscriptions actually land. Three patterns work consistently across verticals:
...
### What's the difference between the BFS and Legacy ReCharge setup?
