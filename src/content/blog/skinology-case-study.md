---
title: "Skinology case study: personalised, dermatologist-led skincare quiz"
description: "How Chilean brand Skinology uses a personalised quiz and an in-house AI model to formulate dermatologist-reviewed skincare for each customer."
...
featuredImage: "/img/blog/skinology-case-study/blogtile_skinology.webp"
draft: false
---

Skincare is a category where the questions a customer needs answered before buying are particularly hard to solve on a generic product page. [Skinology](https://skinology.cl/), a Chilean brand founded in Santiago by Antonia Schlesinger, built a personalised quiz to bridge that gap: a dermatologist-designed assessment that feeds an in-house AI model and produces a bespoke formula for every customer. In this case study Antonia walks us through how the quiz, the AI, and the dermatologist sign-off work together.
...
Skinology's quiz runs on [RevenueHunt: Recommender Quiz for Shopify](/product-recommendation-quiz/). The quiz collects the data Liam needs to formulate, and the same data lets Skinology evolve products to match each customer's changing needs.
...
- For the underlying recommendation logic options Skinology and brands like it pick from, see [product quiz recommendation systems](/product-quiz-recommendation-systems/).
- For the data layer behind segmented marketing, see [customer tags in product quizzes](/how-to-use-customer-tags-in-product-quizzes-to-maximize-sales/) and [Klaviyo zero-party data](/klaviyo-zero-party-data/).
- For consent collection at quiz time, see [marketing consent in your quiz](/product-quiz-marketing-consent/).
- For the broader playbook, see [how to build a successful ecommerce quiz](/how-to-build-a-successful-ecommerce-quiz/) and [quiz creation mistakes that hurt your ecommerce sales](/quiz-creation-mistakes-that-hurt-your-ecommerce-sales/).
