...
This guide covers what the quiz does for a Magento store as a [product recommendation engine](/glossary/product-recommendation-engine/), the use cases that work best, the setup steps, and where the Magento version fits relative to the Shopify and WooCommerce versions.
