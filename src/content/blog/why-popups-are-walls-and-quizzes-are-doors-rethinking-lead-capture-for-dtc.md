...
<div class="not-prose my-10"><svg viewBox="0 0 1200 540" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="pyramid-title" style="width:100%;height:auto;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;background:#eef2ff;border-radius:16px;padding:24px 16px;box-sizing:border-box;"><title id="pyramid-title">The lead quality pyramid: three tiers of lead capture</title><polygon points="280,40 380,40 420,160 240,160" fill="#0F9E9C"/><text x="330" y="110" text-anchor="middle" fill="#fff" font-size="32" font-weight="800">T3</text><polygon points="240,160 420,160 480,320 180,320" fill="#FFD23F" stroke="#16161D" stroke-width="2"/><text x="330" y="250" text-anchor="middle" fill="#16161D" font-size="32" font-weight="800">T2</text><polygon points="180,320 480,320 540,500 120,500" fill="#F87171"/><text x="330" y="420" text-anchor="middle" fill="#fff" font-size="32" font-weight="800">T1</text><rect x="600" y="40" width="560" height="140" rx="10" fill="#0F9E9C"/><text x="624" y="76" fill="#fff" font-size="14" font-weight="700" letter-spacing="0.06em">TIER 3 · EMAIL + RICH ZERO-PARTY PROFILE</text><text x="624" y="108" fill="#fff" font-size="16" font-weight="600">Quiz model · 5-10 data points per lead</text><text x="624" y="134" fill="#fff" font-size="15">Every lead routes to a specific flow.</text><text x="624" y="160" fill="#fff" font-size="15" font-weight="700">Revenue per recipient: highest.</text><rect x="600" y="200" width="560" height="140" rx="10" fill="#FFD23F" stroke="#16161D" stroke-width="2"/><text x="624" y="236" fill="#16161D" font-size="14" font-weight="700" letter-spacing="0.06em">TIER 2 · EMAIL + BASIC PREFERENCE</text><text x="624" y="268" fill="#16161D" font-size="16" font-weight="600">Survey popup · 1-2 data points per lead</text><text x="624" y="294" fill="#16161D" font-size="15">Still interruptive. Limited conditional splits.</text><text x="624" y="320" fill="#16161D" font-size="15" font-weight="700">Revenue per recipient: marginal improvement.</text><rect x="600" y="360" width="560" height="140" rx="10" fill="#F87171"/><text x="624" y="396" fill="#fff" font-size="14" font-weight="700" letter-spacing="0.06em">TIER 1 · EMAIL ONLY</text><text x="624" y="428" fill="#fff" font-size="16" font-weight="600">Standard popup · zero context</text><text x="624" y="454" fill="#fff" font-size="15">Every lead enters the same generic funnel.</text><text x="624" y="480" fill="#fff" font-size="15" font-weight="700">Revenue per recipient: lowest and declining.</text></svg></div>
