...
1.  [Sign up](/sign-up/) for a RevenueHunt account (free plan available)
...
<details>
<summary><strong>Should I ask for an email before or after showing results?</strong></summary>
...
<details>
<summary><strong>How much does a product recommendation quiz cost?</strong></summary>
...
<details>
<summary><strong>What's the typical conversion lift from a product recommendation quiz?</strong></summary>
...
<script type="application/ld+json">
{
  ...
  "@type": "FAQPage",
  "mainEntity": [
    {"@type": "Question", "name": "What's the difference between a product recommendation quiz and a chatbot?", "acceptedAnswer": {"@type": "Answer", "text": "A quiz is structured (multiple-choice, fixed questions), short (under 90 seconds), and works well on mobile. A chatbot is free-form, slower, and depends on the shopper typing. Quizzes convert better for the discovery use case; chatbots fit better for post-purchase support."}},
    {"@type": "Question", "name": "How many questions should a product recommendation quiz have?", "acceptedAnswer": {"@type": "Answer", "text": "5 to 8 questions for most use cases. Fewer than 4 and you can't differentiate enough products. More than 10 and completion rates drop sharply. Use conditional logic to skip irrelevant questions."}},
    {"@type": "Question", "name": "Should I ask for an email before or after showing results?", "acceptedAnswer": {"@type": "Answer", "text": "Optional, never required. Asking before results unlocks email re-engagement for the 60 to 70% of shoppers who don't buy on the first visit, but making it required drops completion by 30%. Best practice: ask, make it skippable, add a soft incentive."}},
