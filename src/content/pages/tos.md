...
RevenueHunt has a service uptime of over 99.9%. You can check if our system is running as expected or experiencing issues in our [app status page](https://status.revenuehunt.com/).

**However, we do have an on-call team and escalation plan to address system disruptions:**
...
RevenueHunt will provide the following support via email and Zoom:

-   First response to critical support requests within 15 minutes. Critical support requests include widespread (multiple customers) service outages and reports of security vulnerabilities from customers.
-   First response to high-priority issues within 6 hours. High priority support requests include inability to access the product from multiple users (for example, multiple users cannot log in) and other similar requests.
-   First response to low-priority issues within 24 hours.
-   You can find more information about our Customer Support activities and scope in [this article](https://revenuehunt.com/faqs/customer-support/).
...
Although our app and website are always active, we might have to temporarily suspend, maybe without prior notice, accessibility to our app or website due to maintenance, repair, update or improvement operations. If you can not access a feature or you detect a bug in our app, please send us an email to [info@revenuehunt.com](mailto:info@revenuehunt.com) and we will fix it as soon as possible.
...
Because GDPR is a new regulation, each merchant has the responsibility to follow the established guidelines for proper usage. If you are a merchant who serves EU citizens, it is necessary to follow these regulations.

For details on what information we collect and how we handle your data, please see our [Privacy Policy](https://revenuehunt.com/privacy/).
...
We have tried to be as clear and concise as possible. However, if you have any questions about these Terms of Service or wish to contact RevenueHunt, please fill in the [contact form](https://revenuehunt.com/contact/) and our legal department will be happy to help you.
