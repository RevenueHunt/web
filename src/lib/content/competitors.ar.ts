...
export const COMPETITORS_AR: Record<string, Competitor> = {
  "octane-ai": {
    ...
    intro: [
      ...
      "RevenueHunt هو اختبار التوصية بالمنتجات الذي تستخدمه أكثر من 20,000 علامة تجارية (4.9★، أكثر من 450 مراجعة). يبدأ مجانًا، ولا يضيف علامة مائية إلى اختبار Shopify الخاص بك في أي خطة، ويتيح لك بناء اختبارات غير محدودة منذ اليوم الأول، ويعمل أبعد من Shopify على WooCommerce و BigCommerce و Magento و Wix وغيرها.",
    ],
    rows: [
  ...
  typeform: {
    ...
    intro: [
      ...
      "RevenueHunt اختبار توصية بالمنتجات من نوع Built-for-Shopify تستخدمه أكثر من 20,000 علامة تجارية (4.9★، أكثر من 450 مراجعة). يربط إجابات كل متسوق بالمنتجات المناسبة من كتالوجك الحيّ، ويعرض صفحة نتائج مخصصة مع إضافة مباشرة إلى السلة، ويلتقط العملاء المحتملين إلى Klaviyo. قمع مبيعات، لا مجرد نموذج.",
    ],
    rows: [
  ...
  zoovu: {
    ...
    intro: [
      ...
      "RevenueHunt اختبار توصية بالمنتجات مركّز تستخدمه أكثر من 20,000 علامة تجارية (4.9★، أكثر من 450 مراجعة). بدلًا من حزمة اكتشاف مؤسسية، يفعل شيئًا واحدًا ببراعة استثنائية، توجيه متسوّقي Shopify إلى المنتج المناسب، بتسعير شفّاف وخطة مجانية وإعداد في اليوم نفسه، دون الحاجة إلى مكالمة مبيعات.",
    ],
    rows: [
      { feature: "خطة مجانية", rh: RH.freePlan, them: "no" },
    ...
    whySwitch: [
      ...
      },
      {
        ...
        body: "RevenueHunt تطبيق Built-for-Shopify بمزامنة كتالوج فورية وتوطين Shopify Markets، مقيَّم بـ 4.9★ من أكثر من 450 تاجرًا. العمق الذي تحتاجه لاكتشاف المنتجات دون العبء المؤسسي.",
      },
    ],
    bestFor:
  ...
  jebbit: {
    ...
    intro: [
      ...
      "RevenueHunt اختبار توصية بالمنتجات مستقل تستخدمه أكثر من 20,000 علامة تجارية (4.9★، أكثر من 450 مراجعة). لست مضطرًا لشراء CDP لاستخدامه: هو اختبار مركّز من نوع Built-for-Shopify بتسعير شفّاف وخطة مجانية وإعداد في اليوم نفسه، ذاتي الخدمة، بلا مكالمة مبيعات.",
    ],
    rows: [
      { feature: "خطة مجانية", rh: RH.freePlan, them: "no" },
      { feature: "تسعير عام شفّاف", rh: RH.transparentPricing, them: "مخصص / اطلب عرضًا توضيحيًا" },
  ...
  nosto: {
    ...
    intro: [
      ...
      "RevenueHunt اختبار توصية بالمنتجات مركّز تستخدمه أكثر من 20,000 علامة تجارية (4.9★، أكثر من 450 مراجعة). بدلًا من حزمة مؤسسية، يوجّه المتسوقين إلى المنتج المناسب بسؤالهم مباشرة، ملتقطًا بيانات zero-party تملكها، بتسعير شفّاف وخطة مجانية وإعداد في اليوم نفسه، دون الحاجة إلى مكالمة مبيعات.",
    ],
    rows: [
      { feature: "خطة مجانية", rh: RH.freePlan, them: "no" },
      { feature: "تسعير عام شفّاف", rh: RH.transparentPricing, them: "مخصص / اطلب عرضًا توضيحيًا" },
  ...
  tolstoy: {
    ...
    intro: [
      ...
      "RevenueHunt اختبار توصية بالمنتجات تستخدمه أكثر من 20,000 علامة تجارية (4.9★، أكثر من 450 مراجعة). يركّز على الاختبار: محرك توصية مخصص يربط إجابات كل متسوق بالمنتجات المناسبة من كتالوجك، يلتقط بيانات zero-party، ويحوّل على صفحة نتائج مخصصة، عبر Shopify و WooCommerce و BigCommerce و Magento و Wix وغيرها.",
    ],
    rows: [
      { feature: "خطة مجانية", rh: RH.freePlan, them: "yes (محدودة)" },
    ...
    whySwitch: [
      ...
      },
      {
        ...
        body: "يعمل RevenueHunt بشكل أصيل على Shopify وأيضًا على WooCommerce و BigCommerce و Magento و Wix و Squarespace، ومستقلًا، بثقة أكثر من 20,000 علامة تجارية و 4.9★ من أكثر من 450 مراجعة.",
      },
    ],
    bestFor:
