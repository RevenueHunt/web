...
export const COMPETITORS_HE: Record<string, Competitor> = {
  "octane-ai": {
    ...
    intro: [
      ...
      "RevenueHunt היא חידון המלצת המוצרים שבו משתמשים יותר מ-20,000 מותגים (4.9★, יותר מ-550 ביקורות). היא מתחילה בחינם, לעולם לא מוסיפה סימן מים לחידון ה-Shopify שלכם בשום תוכנית, מאפשרת לכם לבנות חידונים ללא הגבלה מהיום הראשון, ועובדת מעבר ל-Shopify על WooCommerce, BigCommerce, Magento, Wix ועוד.",
    ],
    rows: [
  ...
  typeform: {
    ...
    intro: [
      ...
      "RevenueHunt היא חידון המלצת מוצרים Built-for-Shopify שבו משתמשים יותר מ-20,000 מותגים (4.9★, יותר מ-550 ביקורות). היא ממפה את התשובות של כל קונה למוצרים הנכונים מהקטלוג החי שלכם, מציגה עמוד תוצאות מותאם אישית עם הוספה ישירה לעגלה, ולוכדת לידים ל-Klaviyo. משפך מכירות, לא רק טופס.",
    ],
    rows: [
  ...
  zoovu: {
    ...
    intro: [
      ...
      "RevenueHunt היא חידון המלצת מוצרים ממוקד שבו משתמשים יותר מ-20,000 מותגים (4.9★, יותר מ-550 ביקורות). במקום חבילת גילוי ארגונית, היא עושה דבר אחד בצורה יוצאת דופן, מנחה קוני Shopify למוצר הנכון, עם תמחור שקוף, תוכנית חינמית, והקמה באותו יום, ללא צורך בשיחת מכירה.",
    ],
    rows: [
      { feature: "תוכנית חינמית", rh: RH.freePlan, them: "no" },
    ...
    whySwitch: [
      ...
      },
      {
        ...
        body: "RevenueHunt היא אפליקציית Built-for-Shopify עם סנכרון קטלוג בזמן אמת ולוקליזציה של Shopify Markets, מדורגת 4.9★ על ידי יותר מ-550 סוחרים. העומק שאתם צריכים לגילוי מוצרים בלי תקורה ארגונית.",
      },
    ],
    bestFor:
  ...
  jebbit: {
    ...
    intro: [
      ...
      "RevenueHunt היא חידון המלצת מוצרים עצמאי שבו משתמשים יותר מ-20,000 מותגים (4.9★, יותר מ-550 ביקורות). אינכם צריכים לקנות CDP כדי להשתמש בה: זה חידון ממוקד, Built-for-Shopify, עם תמחור שקוף, תוכנית חינמית והקמה באותו יום, בשירות עצמי, ללא שיחת מכירה.",
    ],
    rows: [
      { feature: "תוכנית חינמית", rh: RH.freePlan, them: "no" },
      { feature: "תמחור ציבורי שקוף", rh: RH.transparentPricing, them: "מותאם / בקשו דמו" },
  ...
  nosto: {
    ...
    intro: [
      ...
      "RevenueHunt היא חידון המלצת מוצרים ממוקד שבו משתמשים יותר מ-20,000 מותגים (4.9★, יותר מ-550 ביקורות). במקום חבילה ארגונית, היא מנחה קונים למוצר הנכון על ידי שאלה ישירה, ולכידת zero-party data שבבעלותכם, עם תמחור שקוף, תוכנית חינמית והקמה באותו יום, ללא צורך בשיחת מכירה.",
    ],
    rows: [
      { feature: "תוכנית חינמית", rh: RH.freePlan, them: "no" },
      { feature: "תמחור ציבורי שקוף", rh: RH.transparentPricing, them: "מותאם / בקשו דמו" },
  ...
  tolstoy: {
    ...
    intro: [
      ...
      "RevenueHunt היא חידון המלצת מוצרים שבו משתמשים יותר מ-20,000 מותגים (4.9★, יותר מ-550 ביקורות). היא מתחילה בחידון: מנוע המלצות ייעודי ממפה את התשובות של כל קונה למוצרים הנכונים מהקטלוג שלכם, לוכד zero-party data, וממיר בעמוד תוצאות מותאם אישית, על פני Shopify, WooCommerce, BigCommerce, Magento, Wix ועוד.",
    ],
    rows: [
      { feature: "תוכנית חינמית", rh: RH.freePlan, them: "yes (מוגבל)" },
    ...
    whySwitch: [
      ...
      },
      {
        ...
        body: "RevenueHunt רצה באופן מקורי על Shopify וגם על WooCommerce, BigCommerce, Magento, Wix, Squarespace ועצמאי, מהימנה על ידי יותר מ-20,000 מותגים עם 4.9★ מיותר מ-550 ביקורות.",
      },
    ],
    bestFor:
